...
#waddle-badge { position:fixed; top:12px; left:12px; z-index:9998; background:rgba(12,12,18,.85); border:1px solid var(--c-border); border-radius:20px; padding:4px 10px; font-size:.7rem; font-weight:700; color:var(--c); letter-spacing:.5px; pointer-events:none; user-select:none; backdrop-filter:blur(4px); }
